...
class _DashboardScreenState extends State<DashboardScreen> {  
  ...
  void initState() {  
    ...
    Provider.of<ProductProvider>(context, listen: false).fetchProducts(); // Fetch products  
  }  
  ...
  Widget build(BuildContext context) {  
    return Scaffold(  
      appBar: AppBar(  
        title: const Text('Dashboard Produk', style: TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
        actions: [  
          IconButton(  
  ...
  void _showErrorDialog(BuildContext context, String message) {  
    showDialog(  
      ...
      builder: (context) => AlertDialog(  
        title: const Text('Error', style: TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
        content: Text(message, style: const TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
        actions: [  
          TextButton(  
            onPressed: () => Navigator.of(context).pop(),  
            child: const Text('OK', style: TextStyle(fontFamily: 'DynaPuff')), // DynaPuff font  
          ),  
        ],  
      ),  
    );  
